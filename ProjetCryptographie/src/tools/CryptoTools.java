...
{ 
    ...
    public static byte[] encrypt3DES(String str, String encrKey)
    {
        try
        {  
    ...
    public static void encryptFile3DES(String content, String file, String key)
    {
        FileTools.WriteFile(encrypt3DES(content, key), file);
    }
